...
public class Constants {
    ...
    public static final String CI_SYSTEM = "hudsonslaves";
    ...
    public static final String CONFIG_CONTAINER_NAME = "hudsonconfig";
    ...
    public static final String STORAGE_ACCOUNT_PREFIX = "hudson";
    ...
    public static final String RESOURCE_GROUP_NAME = "Hudson";
